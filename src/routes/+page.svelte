...
/* ========== HEADER (Fixed, Gradient, Responsive) ========== */
.header-fixed {
  position: fixed;
  top: 0;
  left: 0;
...
.about-grid {
  ...
  border-radius: 48px;
  padding: 48px;
  box-shadow: 0 30px 60px -20px rgba(30, 58, 74, 0.3), 0 10px 30px -12px rgba(0, 0, 0, 0.2), inset 0 1px 2px rgba(255, 255, 255, 0.8);
  border: 1px solid rgba(239, 185, 120, 0.2);
  transition: box-shadow 0.4s ease, transform 0.4s ease, border-color 0.3s ease;
}

.about-grid:hover {
  box-shadow: 0 40px 80px -20px rgba(30, 58, 74, 0.4), 0 15px 40px -10px rgba(0, 0, 0, 0.25), inset 0 1px 3px rgba(255, 255, 255, 0.9);
...
.founder-card {
  ...
  overflow: hidden;
  position: relative;
  background-image: url('/images/SNR-IIMA-PIC-NANDA-SIR.jpg'); /* Adjust path */
...
.copyright {
  ...
  font-size: 14px;
  background: linear-gradient(135deg, #6B0F9C 0%, #B91372 40%, #B91372 100%);
  border-top: 1px solid rgba(239, 185, 120, 0.2);
}
...
/* Tablet Portrait (≤820px) – hamburger menu active */
...
/* Animation for partner items (fade up) */
.partner-item {
  opacity: 0;
